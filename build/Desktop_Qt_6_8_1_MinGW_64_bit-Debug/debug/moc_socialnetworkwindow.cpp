...
static constexpr auto qt_meta_stringdata_ZN19SocialNetworkWindowE = QtMocHelpers::stringData(
    "SocialNetworkWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN19SocialNetworkWindowE[] = {
...
Q_CONSTINIT const QMetaObject SocialNetworkWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN19SocialNetworkWindowE.offsetsAndSizes,
    qt_meta_data_ZN19SocialNetworkWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN19SocialNetworkWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *SocialNetworkWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN19SocialNetworkWindowE.stringdata0))
